...
export default function CombinedResults({ data, onQueryClick, currentQuery }: CombinedResultsProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      {/* Sticky Header with Query and Tabs */}
      <div className="sticky top-0 bg-white z-40 border-b border-gray-200 mb-4 pt-2">
